...
public class IamportClient {
    ...
    public IamportResponse<Purchase> paymentByImpUid(String impUid) throws Exception {
        ...
        if(token != null) {
            ...
            Type listType = new TypeToken<IamportResponse<Purchase>>(){}.getType();
            IamportResponse<Purchase> payment = gson.fromJson(response, listType);
    ...
    public IamportResponse<Purchase> paymentByMerchantUid(String merchantUid) throws Exception {
...
/*    public IamportResponse<Purchase> cancelPayment(CancelData cancelData) throws Exception {
