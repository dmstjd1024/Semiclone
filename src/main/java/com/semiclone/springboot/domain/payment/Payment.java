...
public class Payment {
    ...
    @Column(nullable = false)
    private BigDecimal paymentAmount;    //  총 결제금액
    ...
    @Column(nullable = false)
    private String paymentStatus = "1";    //  결제 상태
    ...
    @Builder
    public Payment(String receiverName, String receiverPhone, BigDecimal paymentAmount, 
                    String accountId, String paymentMethod, String giftCardIds, 
                    String movieCouponIds, String ticketIds) {
